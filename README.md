...
To install this plugin, copy the content of the file 'ZoomToBelgium-v.0.1.1.zip' to <YOUR PROFILE>\.qgis2\python\plugins for QGIS 2.x or <YOUR PROFILE>\QGIS\QGIS3\profiles\default for QGIS 3.x. For now this plugin is not yet avialable in the QGIS plugin repository.
