...
class ZoomToBelgium:
    ...
    def savesettings(self):
        tosavemunicipality=self.searchmunicipality(municipality_name,self.dlg.comboGemeentes.currentText().strip())
        s.setValue("zoomtobelgium/municipality", tosavemunicipality)
        self.zoomtomunicipality(tosavemunicipality)
