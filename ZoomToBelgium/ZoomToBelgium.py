...
class ZoomToBelgium:
    def __init__(self, iface):
        ...
        municipality_name['160']=u"Fontaine-l'Évêque"
        ...
        municipality_name['40']=u"Mont-de-l'Enclus"
        ...
        for combovalue in combovalues:
            ...
            # print(self.searchmunicipality(municipality_name,combovalue.decode('utf-8'))) #test to see if searchmunicipality works
    ...
    def savesettings(self):
        s = QSettings()
        s.setValue("zoomtobelgium/municipality", self.searchmunicipality(municipality_name,self.dlg.comboGemeentes.currentText().decode('utf-8')) )
        # print self.searchmunicipality(municipality_name,self.dlg.comboGemeentes.currentText().decode('utf-8'))    
    def run(self):
